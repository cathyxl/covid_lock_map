...
DATA_PATH = "data"
PROCESSED_JSON_PATH = "%s/processed_data" % DATA_PATH
LOCK_CONDITION_PATH = "%s/lock_condition" % DATA_PATH
CRAWLED_PATH = "%s/crawled_files/original_csv" % DATA_PATH
...
# for prov in region_dict:
#     regions.append(prov)
#     for c in region_dict[prov]['city']:
#         city_prov[c] = prov
#         if c not in cities:
#             regions.append(c)
#             cities.append(c)
# with open('city_province.pk', 'wb') as f:
#     pickle.dump(city_prov, f)
#
# with open('cities.pk', 'wb') as f:
#     pickle.dump(cities, f)
#
# with open('regions.pk', 'wb') as f:
